...
function FacebookLogin () {
  ...
  console.log(posted);
const userdef = "https://cdn-icons-png.flaticon.com/512/149/149071.png"
  useEffect(() => {
  ...
  return (
   <div>
    ...
    <img  src='https://media.licdn.com/dms/image/C4D12AQGZb8tWl5brSw/article-cover_image-shrink_720_1280/0/1650406092050?e=2147483647&v=beta&t=2sxwuP_HprXY4KOKwDJKhtolmm1-u09YXsO0mkIiZPM' style={{ width: '180px', height: '80px' , position: 'relative', left:"-50%" }} />
...
<Link href="/get">
 ...
 <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2mejIovdVKePsxohV7u6FmLj6i4CqaVLT1A&s" alt="User Picture"  />
                ...
                <div class="stories__content">
                    ...
                    <div class="story__avatar">
                      <div class="story__border">
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <rect width="80" height="500"  fill="#EEF" rx="8" ry="8" />
                          <defs>
                            <linearGradient
                              y2="0"
                              x2="1"
                      ...
                      <br/> <span class="story__user">Add To <br/> Story</span><br/>
                    </div>
                    ...
                    <div class="story__avatar">
                      <div class="story__border">
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <rect width="80" height="500"  fill="#EFEFEF" rx="8" ry="8" />
                        </svg>
                      </div>
                      <div class="story__picture">
                        <img src={userdef} alt="User Picture" />
                      </div>
                      <br/><span class="story__user">Umer</span><br/>
                    </div>
                  ...
                  <button class="story story--has-story">
                    <div class="story__avatar">
                      ...
                      <br/><span class="story__user">Taha</span><br/>
                    </div>
                  ...
                  <button class="story">
                    <div class="story__avatar">
                      ...
                      <br/><span class="story__user">Kashif</span><br/>
                    </div>
                  ...
                  <button class="story">
                    <div class="story__avatar">
                      ...
                      <br/>
                      <span class="story__user">Aqdas</span><br/>
                    </div>
                  ...
                  <button class="story">
                    <div class="story__avatar">
                      ...
                      <br/>
                      <span class="story__user">Bilal</span>
                      <br/>
                    </div>
                    <br/>
                  </button>
      ...
      <article class="post">
        <div class="post__header">
          <div class="post__profile">
            <a
              href="https://www.facebook.com/mohammadilyas.imran/"
              target="_blank"
              class="post__avatar"
            >
              <img src={userdef} alt="User Picture" />
        ...
        <div class="post__footer">
          ...
          <div class="post__infos">
            <div class="post__likes">
              ...
              <span
                >Liked by
                <a class="post__name--underline" href="#">Umer</a> and
                <a href="#">2 others</a></span
              >
            </div>
            ...
            <section class="side-menu">
              <div class="side-menu__user-profile">
                ...
                <div class="side-menu__user-info">
                  <a href="https://www.facebook.com/mohammadilyas.imran/" target="_blank"
                    >Friends</a
                  >
                  <br/>
                </div>
              ...
              <div class="side-menu__suggestions-section">
                ...
                <div class="side-menu__suggestions-content">
                  ...
                  <pre>
                  <button class="side-menu__suggestion-button">Add Friend</button>              <button class="side-menu__suggestion-button-remove">Remove</button>
                  </pre>
                ...
                <button class="side-menu__user-button">See All</button>
              </div>
